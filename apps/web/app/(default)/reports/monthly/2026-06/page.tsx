              ...
              metadata={
                <>
                  ...
                  <MetaLabel label="Checked">
                    {formatReportDate(record.lastCheckedAt, locale)}
                  </MetaLabel>
                </>
              }
            >
              <h2>
                <Link data-i18n="preserve" href={record.universityUrl}>{record.name}</Link>
              </h2>
              <p>{record.summary}</p>
            </DataListRow>
          ))}
        ...
        <DataList>
          {report.coverageGroups.map((group) => (
            ...
            >
              ...
              <p>
                {group.universityCount.toLocaleString(locale)} university
                records across {group.countryCount.toLocaleString(locale)}{" "}
