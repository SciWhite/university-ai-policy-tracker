import BasePage, { generateMetadata as baseGenerateMetadata, generateStaticParams } from "../../../../../../(default)/reports/monthly/2026-06/coverage/[region]/page";
...
export const generateMetadata = createLocalizedSurfaceMetadata(
  ...
  (params) => `/reports/monthly/2026-06/coverage/${params.region}`
);
