...
export function buildAnalyticsEventRecord(
  ...
  return {
    ...
    sourceCategory: getStringProperty(sanitized, "source_category"),
    sourceDomain: getStringProperty(sanitized, "source_domain"),
    sourceName: getStringProperty(sanitized, "source_name"),
    referrerDomain: getStringProperty(sanitized, "referrer_domain"),
    landingPath: getStringProperty(sanitized, "landing_path"),
    utmSource: getStringProperty(sanitized, "utm_source"),
    utmMedium: getStringProperty(sanitized, "utm_medium"),
    utmCampaign: getStringProperty(sanitized, "utm_campaign"),
    utmTerm: getStringProperty(sanitized, "utm_term"),
    utmContent: getStringProperty(sanitized, "utm_content"),
